...
- Only existing, active privileged accounts can be promoted: claimed members and the internal accounts already listed on this page. No new accounts are created here.
- Guardrails:
...
- **Changes** — UI: Super Admin switch in the role detail panel and internal accounts table, confirmation dialog, four-language strings. Backend: widened grant/revoke validators.
