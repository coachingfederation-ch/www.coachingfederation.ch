...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      event_cce_applications: {
        Row: {
          ...
          delivery_method: Database["public"]["Enums"]["event_cce_delivery"] | null;
          event_id: string;
          id: string;
    ...
    Views: {
      ...
      events_public: {
        Row: {
          ...
          location_mode: Database["public"]["Enums"]["event_location_mode"] | null;
          map_location: string | null;
          online_url: string | null;
          published_at: string | null;
          ...
          registration_mode: Database["public"]["Enums"]["event_registration_mode"] | null;
    ...
    Enums: {
      ...
      article_status: "draft" | "scheduled" | "published" | "unpublished" | "review";
      ...
      event_registration_mode: "none" | "rsvp" | "rsvp_members" | "rsvp_tickets" | "rsvp_invited";
