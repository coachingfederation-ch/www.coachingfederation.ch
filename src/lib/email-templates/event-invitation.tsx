/**
 * React Email template for personal event invitations.
 * Exports: template. Registered in lib/email-templates/registry.ts.
 *
 * Shares the chrome of the waitlist invitation on purpose: the invitee should
 * recognise the sender at a glance.
 */
...
import { INVITATION_COPY } from "./event-invitation-copy";
...
const Email = ({
  ...
  const copy = INVITATION_COPY[locale] ?? INVITATION_COPY.en;
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>{copy.personal}</Text>
