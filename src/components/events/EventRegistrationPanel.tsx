...
import { checkEventInvitation, declineEventInvitation } from "@/lib/event-invitations.functions";
...
export function EventRegistrationPanel({ event }: { event: PublicEvent }) {
  ...
  // Two independent axes: who may register (nobody, anyone, active members,
  // invited members) and whether the organiser offers ticket tiers.
