...
| `event-editor-stages.ts`          | Lifecycle stages of the staff event editor: stage list, opening stage, per-session memory.       |
...
| `guides.index`, `guides.$slug`, `_staff/manage.guides`                                                          | Public guides index and detail (with `$locale/` mirrors) and the editor-gated guides CMS. See `docs/member-guides.md`.                                  |
